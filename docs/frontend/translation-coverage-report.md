# Translation Coverage Report - Prym
...
Date: $(date)
Analysis performed on all Razor pages and translation files in the Prym.Client project.
...
---
Generated by Prym Translation Analysis Tool
