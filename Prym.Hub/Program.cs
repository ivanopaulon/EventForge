using Prym.Hub.Auth;
using Prym.Hub.Configuration;
using Prym.Hub.Hubs;
using Prym.Hub.Services;
...
// Mirrors the same single-file pattern used by Prym.Client.
...
builder.Services.AddSwaggerGen(c => c.SwaggerDoc("v1", new() { Title = "Prym UpdateHub API", Version = "v1" }));
...
Log.Information("Prym UpdateHub starting. Endpoints: {Urls}",
