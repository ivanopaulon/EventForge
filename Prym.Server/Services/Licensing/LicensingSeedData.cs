...
public static class LicensingSeedData
{
    ...
    public static async Task SeedLicensingDataAsync(PrymDbContext context)
    {
    ...
    private static async Task CreateLicenseFeatures(PrymDbContext context, License license, List<Permission> permissions, string tier)
    {
    ...
    public static async Task AssignBasicLicenseToTenantAsync(PrymDbContext context, Guid tenantId)
    {
