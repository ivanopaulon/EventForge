...
## Overview
This directory contains the business logic layer of Prym, organized into domain-specific service groups and facades.
...
**Location**: `Prym.Server/Services/Documents/DocumentFacade.cs`
...
**Location**: `Prym.Server/Services/Warehouse/WarehouseFacade.cs`
