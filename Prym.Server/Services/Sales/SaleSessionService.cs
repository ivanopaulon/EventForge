...
namespace Prym.Server.Services.Sales;
...
", cancellationToken);
    ...
    private SaleSessionDto MapToDtoWithProducts(SaleSession session, Dictionary<Guid, Prym.Server.Data.Entities.Products.Product> products, int childSessionCount = 0)
    {
    ...
    private SaleItemDto MapItemToDto(SaleItem item, Dictionary<Guid, Prym.Server.Data.Entities.Products.Product> products)
    {
