...
using PriceListBusinessPartyStatus = Prym.Server.Data.Entities.PriceList.PriceListBusinessPartyStatus;
using PriceListEntryStatus = Prym.Server.Data.Entities.PriceList.PriceListEntryStatus;
using PriceListStatus = Prym.Server.Data.Entities.PriceList.PriceListStatus;

namespace Prym.Server.Services.PriceLists;
    ...
    ITenantContext tenantContext) : IPriceListGenerationService
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        {
            query = query.Where(p => p.Status == Prym.Server.Data.Entities.Products.ProductStatus.Active);
        }
