...
using AlertConfiguration = Prym.Server.Data.Entities.Alerts.AlertConfiguration;
using AlertEntity = Prym.Server.Data.Entities.Alerts.SupplierPriceAlert;
using AlertFrequency = Prym.Server.Data.Entities.Alerts.AlertFrequency;
using AlertSeverity = Prym.Server.Data.Entities.Alerts.AlertSeverity;
using AlertStatus = Prym.Server.Data.Entities.Alerts.AlertStatus;
using AlertType = Prym.Server.Data.Entities.Alerts.AlertType;

namespace Prym.Server.Services.Alerts;
