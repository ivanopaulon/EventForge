...
namespace Prym.Server.Services.Banks;
...
public interface IBankService
{
    ...
    Task<PagedResult<BankDto>> GetBanksAsync(PaginationParameters pagination, CancellationToken cancellationToken = default);
