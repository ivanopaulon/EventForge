...
using SalesPaymentMethod = Prym.Server.Data.Entities.Sales.PaymentMethod;
    ...
    ILogger<StoreSeeder> logger) : IStoreSeeder
{
    ...
    public async Task<bool> SeedDefaultPosAsync(Guid tenantId, CancellationToken cancellationToken = default)
    {
        try
        {
            ...
            var defaultPos = new Prym.Server.Data.Entities.Store.StorePos
            {
                Id = Guid.NewGuid(),
                Name = "Cassa Principale",
                Description = "Punto cassa principale",
                Status = Prym.Server.Data.Entities.Store.CashRegisterStatus.Active,
                Location = "Front Desk",
    ...
    public async Task<bool> SeedDefaultOperatorAsync(Guid tenantId, CancellationToken cancellationToken = default)
    {
        try
        {
            ...
            var defaultOperator = new Prym.Server.Data.Entities.Store.StoreUser
            {
                Id = Guid.NewGuid(),
                ...
                Role = "Cashier",
                Status = Prym.Server.Data.Entities.Store.CashierStatus.Active,
                IsOnShift = false,
