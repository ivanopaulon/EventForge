...
using EntityProductCodeStatus = Prym.Server.Data.Entities.Products.ProductCodeStatus;
using EntityProductStatus = Prym.Server.Data.Entities.Products.ProductStatus;
using EntityProductUnitStatus = Prym.Server.Data.Entities.Products.ProductUnitStatus;
...
#pragma warning restore CS0618 // Type or member is obsolete
    ...
    public async Task<ProductSupplierDto> AddProductSupplierAsync(CreateProductSupplierDto createProductSupplierDto, string currentUser, CancellationToken cancellationToken = default)
    {
        try
        {
            ...
            if (supplier.PartyType != Prym.Server.Data.Entities.Business.BusinessPartyType.Fornitore && supplier.PartyType != Prym.Server.Data.Entities.Business.BusinessPartyType.ClienteFornitore)
            {
        ...
        try
        {
            ...
            var latestPurchases = await context.DocumentRows
                ...
                .Where(dr => dr.DocumentHeader != null &&
                            ...
                            dr.DocumentHeader.ApprovalStatus == Prym.Server.Data.Entities.Documents.ApprovalStatus.Approved &&
        ...
        try
        {
            ...
            var query = context.DocumentRows
                ...
                .Where(r => r.DocumentHeader != null &&
                            ...
                            r.DocumentHeader.ApprovalStatus == Prym.Server.Data.Entities.Documents.ApprovalStatus.Approved &&
