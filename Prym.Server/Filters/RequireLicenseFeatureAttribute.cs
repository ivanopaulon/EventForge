...
public class RequireLicenseFeatureAttribute : Attribute, IAsyncAuthorizationFilter
{
    ...
    public async Task OnAuthorizationAsync(AuthorizationFilterContext context)
    {
        ...
        var dbContext = context.HttpContext.RequestServices.GetRequiredService<PrymDbContext>();
    ...
    private async Task<List<string>> GetUserPermissionsAsync(PrymDbContext dbContext, ClaimsPrincipal user)
    {
