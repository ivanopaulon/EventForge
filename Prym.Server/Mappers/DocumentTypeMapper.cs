...
public static class DocumentTypeMapper
{
    ...
    public static DocumentType ToEntity(CreateDocumentTypeDto dto)
    {
        return new DocumentType
        {
            ...
            RequiredPartyType = (Prym.Server.Data.Entities.Business.BusinessPartyType)dto.RequiredPartyType,
            Notes = dto.Notes
        };
    }
    ...
    public static void UpdateEntity(DocumentType entity, UpdateDocumentTypeDto dto)
    {
        ...
        entity.RequiredPartyType = (Prym.Server.Data.Entities.Business.BusinessPartyType)dto.RequiredPartyType;
