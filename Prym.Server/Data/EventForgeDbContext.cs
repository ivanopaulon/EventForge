...
using Prym.Server.Data.Entities.Calendar;
using Prym.Server.Data.Entities.Chat;
...
public partial class PrymDbContext : DbContext
{
    ...
    public PrymDbContext(DbContextOptions<PrymDbContext> options)
        : base(options)
    {
    }

    public PrymDbContext(DbContextOptions<PrymDbContext> options, IHttpContextAccessor? httpContextAccessor)
        : base(options)
    {
    ...
    public DbSet<Prym.Server.Data.Entities.FiscalPrinting.DailyClosureRecord> DailyClosureRecords { get; set; }
