...
namespace Prym.DTOs.Teams.Validators
{
    /// <summary>
    /// Validator for <see cref="UpdateTeamMemberDto"/>.
    /// </summary>
    public class UpdateTeamMemberDtoValidator : AbstractValidator<UpdateTeamMemberDto>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateTeamMemberDtoValidator"/> class.
        /// </summary>
