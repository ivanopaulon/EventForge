...
{
    /// <summary>
    /// Validator for UpdateStorageLocationDto.
    /// </summary>
    public class UpdateStorageLocationDtoValidator : AbstractValidator<UpdateStorageLocationDto>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateStorageLocationDtoValidator"/> class.
        /// </summary>
        public UpdateStorageLocationDtoValidator()
        {
            RuleFor(x => x.Code)
                .MaximumLength(30)
