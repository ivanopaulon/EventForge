...
namespace Prym.DTOs.PriceLists.Validators
{
    /// <summary>
    /// Validator for <see cref="CreatePriceListDto"/>.
    /// </summary>
    public class CreatePriceListDtoValidator : AbstractValidator<CreatePriceListDto>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreatePriceListDtoValidator"/> class.
        /// </summary>
