...
namespace Prym.DTOs.Products.Validators
{
    /// <summary>
    /// Validator for <see cref="CreateProductSupplierDto"/>.
    /// </summary>
    public class CreateProductSupplierDtoValidator : AbstractValidator<CreateProductSupplierDto>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateProductSupplierDtoValidator"/> class.
        /// </summary>
