...
{
    /// <summary>
    /// Total number of documents requested for approval.
    /// </summary>
    public int TotalCount { get; set; }

    /// <summary>
    /// Number of documents successfully approved.
    /// </summary>
    public int SuccessCount { get; set; }

    /// <summary>
    /// Number of documents that failed to approve.
    /// </summary>
    public int FailedCount { get; set; }

    /// <summary>
    /// List of errors that occurred during the approval.
    /// </summary>
