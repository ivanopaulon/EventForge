...
namespace Prym.DTOs.Station.Validators
{
    /// <summary>
    /// Validator for <see cref="UpdateStationDto"/>.
    /// </summary>
    public class UpdateStationDtoValidator : AbstractValidator<UpdateStationDto>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateStationDtoValidator"/> class.
        /// </summary>
