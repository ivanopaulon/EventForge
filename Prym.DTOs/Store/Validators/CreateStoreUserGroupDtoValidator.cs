...
namespace Prym.DTOs.Store.Validators
{
    /// <summary>
    /// Validator for CreateStoreUserGroupDto.
    /// </summary>
    public class CreateStoreUserGroupDtoValidator : AbstractValidator<CreateStoreUserGroupDto>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateStoreUserGroupDtoValidator"/> class.
        /// </summary>
        public CreateStoreUserGroupDtoValidator()
        {
            RuleFor(x => x.Code)
                .NotEmpty()
