...
using ProductStatus = Prym.Server.Data.Entities.Products.ProductStatus;

namespace Prym.Tests.Data;

/// <summary>
/// Unit tests for PrymDbContext audit logging and concurrency handling.
/// </summary>
[Trait("Category", "Unit")]
public class PrymDbContextAuditTests : IDisposable
{
    private readonly PrymDbContext _context;
    private readonly Guid _tenantId = Guid.NewGuid();

    public PrymDbContextAuditTests()
    {
