...
using Prym.Server.Data.Entities.Promotions;
...
using EntityPromotionRuleType = Prym.Server.Data.Entities.Promotions.PromotionRuleType;

namespace Prym.Tests.Services.Promotions
{
    /// <summary>
    ...
    public class PromotionServiceTests : IDisposable
    {
        ...
        public async Task Promotion_RowVersion_IsNotNullAfterSave()
        {
            // Arrange
            var promotionId = Guid.NewGuid();
            var promotion = new Prym.Server.Data.Entities.Promotions.Promotion
            {
                Id = promotionId,
