...
using Prym.Server.Services.Audit;
using Prym.Server.Services.Products;
using Prym.Server.Services.Tenants;
using Microsoft.EntityFrameworkCore;
using Microsoft.Extensions.Logging;
using Moq;

namespace Prym.Tests.Services.Products;
...
public class ProductServiceBarcodeTests : IDisposable
{
    ...
    private readonly Mock<Prym.Server.Services.CodeGeneration.IDailyCodeGenerator> _mockCodeGenerator;
    private readonly Mock<Prym.Server.Services.PriceHistory.ISupplierProductPriceHistoryService> _mockPriceHistoryService;
    ...
    public ProductServiceBarcodeTests()
    {
        ...
        var options = new DbContextOptionsBuilder<PrymDbContext>()
            ...
            .Options;
        _context = new PrymDbContext(options);

        // Create mocks
        _mockAuditLogService = new Mock<IAuditLogService>();
        _mockTenantContext = new Mock<ITenantContext>();
        _mockLogger = new Mock<ILogger<ProductService>>();
        _mockCodeGenerator = new Mock<Prym.Server.Services.CodeGeneration.IDailyCodeGenerator>();
        _mockPriceHistoryService = new Mock<Prym.Server.Services.PriceHistory.ISupplierProductPriceHistoryService>();
