...
using Prym.Server.Data.Entities.Business;
using Prym.Server.Data.Entities.Documents;
...
using Moq;
using Address = Prym.Server.Data.Entities.Common.Address;
using Contact = Prym.Server.Data.Entities.Common.Contact;
using PriceList = Prym.Server.Data.Entities.PriceList.PriceList;
using PriceListBusinessParty = Prym.Server.Data.Entities.PriceList.PriceListBusinessParty;

namespace Prym.Tests.Services.Business;
...
public class BusinessPartyService_FullDetailTests : IDisposable
{
    ...
    private async Task<Guid> SeedTestDataAsync()
    {
        ...
        var businessParty = new BusinessParty
        {
            ...
            Name = "Test Company",
            TaxCode = "TC123456",
            PartyType = Prym.Server.Data.Entities.Business.BusinessPartyType.Cliente,
            TenantId = _tenantId,
            CreatedBy = _testUser,
