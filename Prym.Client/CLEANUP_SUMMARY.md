...
## Overview
Comprehensive cleanup of Prym.Client to remove deprecated components and obsolete patterns.
...
This cleanup successfully removed 16 files and over 5,400 lines of deprecated code, improving the overall quality and maintainability of the Prym.Client codebase. The application now follows more consistent UI patterns with dedicated detail pages for entity management and selective use of drawers/dialogs only where they provide clear UX benefits.
