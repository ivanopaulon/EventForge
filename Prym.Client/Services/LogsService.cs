...
namespace Prym.Client.Services
{
    public interface ILogsService
    {
        ...
        Task<Prym.DTOs.Audit.AuditTrailStatisticsDto> GetAuditLogStatisticsAsync();
        ...
        ILogger<LogsService> logger) : ILogsService
    {
        ...
        public async Task<Prym.DTOs.Audit.AuditTrailStatisticsDto> GetAuditLogStatisticsAsync()
        {
