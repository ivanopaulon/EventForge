...
This directory contains Blazor components for the Prym Sales/POS system (Epic #277 Phase 3).

**Location**: `/Prym.Client/Shared/Components/Sales/`
...
All components use styles from `/Prym.Client/wwwroot/css/sales.css`
...
```razor
@page "/sales/wizard"
@using Prym.Client.Shared.Components.Sales
...
**Solution**: Ensure `@using Prym.DTOs.Sales` is in `_Imports.razor`
...
**Maintainer**: Prym Development Team  
