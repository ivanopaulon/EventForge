...
using Prym.Client.Services.Documents;
using Prym.Client.Services.Updates;
...
builder.Services.AddScoped<Prym.Client.Services.External.IVatLookupService, Prym.Client.Services.External.VatLookupService>();

// Add ViewModels
builder.Services.AddScoped<Prym.Client.ViewModels.ProductDetailViewModel>();
builder.Services.AddScoped<Prym.Client.ViewModels.InventoryDetailViewModel>();
builder.Services.AddScoped<Prym.Client.ViewModels.WarehouseDetailViewModel>();
builder.Services.AddScoped<Prym.Client.ViewModels.StorageLocationDetailViewModel>();
builder.Services.AddScoped<Prym.Client.ViewModels.LotDetailViewModel>();

// Onda 2: Documents & Financial ViewModels
builder.Services.AddScoped<Prym.Client.ViewModels.DocumentTypeDetailViewModel>();
builder.Services.AddScoped<Prym.Client.ViewModels.DocumentHeaderDetailViewModel>();
builder.Services.AddScoped<Prym.Client.ViewModels.DocumentCounterDetailViewModel>();
builder.Services.AddScoped<Prym.Client.ViewModels.VatRateDetailViewModel>();
builder.Services.AddScoped<Prym.Client.ViewModels.VatNatureDetailViewModel>();
builder.Services.AddScoped<Prym.Client.ViewModels.PaymentTermDetailViewModel>();
...
builder.Services.AddScoped<Prym.Client.ViewModels.OperatorDetailViewModel>();
builder.Services.AddScoped<Prym.Client.ViewModels.OperatorGroupDetailViewModel>();
builder.Services.AddScoped<Prym.Client.ViewModels.PosDetailViewModel>();
builder.Services.AddScoped<Prym.Client.ViewModels.StationDetailViewModel>();

// POS ViewModel
builder.Services.AddScoped<Prym.Client.ViewModels.POSViewModel>();
...
builder.Services.AddScoped<Prym.Client.Services.Schema.IEntitySchemaProvider, Prym.Client.Services.Schema.EntitySchemaProvider>();
...
builder.Services.AddScoped<Prym.Client.Services.Sales.ISalesService, Prym.Client.Services.Sales.SalesService>();
builder.Services.AddScoped<Prym.Client.Services.Sales.IPaymentMethodService, Prym.Client.Services.Sales.PaymentMethodService>();
builder.Services.AddScoped<Prym.Client.Services.Sales.INoteFlagService, Prym.Client.Services.Sales.NoteFlagService>();
builder.Services.AddScoped<Prym.Client.Services.Sales.ITableManagementService, Prym.Client.Services.Sales.TableManagementService>();
...
builder.Services.AddSingleton<Prym.Client.Services.Mock.IMockFidelityService, Prym.Client.Services.Mock.MockFidelityService>();

// Register authenticated HTTP client handler for Store services
builder.Services.AddTransient<Prym.Client.Services.Store.AuthenticatedHttpClientHandler>();

// Add Store management services with configured HttpClient and authentication handler
builder.Services.AddHttpClient<Prym.Client.Services.Store.IStoreUserService, Prym.Client.Services.Store.StoreUserService>(client =>
{
    client.BaseAddress = new Uri(apiBaseUrl);
    client.Timeout = TimeSpan.FromSeconds(30);
    client.DefaultRequestHeaders.Add("Accept", "application/json");
})
.AddHttpMessageHandler<Prym.Client.Services.Store.AuthenticatedHttpClientHandler>();

builder.Services.AddHttpClient<Prym.Client.Services.Store.IStorePosService, Prym.Client.Services.Store.StorePosService>(client =>
{
    client.BaseAddress = new Uri(apiBaseUrl);
    client.Timeout = TimeSpan.FromSeconds(30);
    client.DefaultRequestHeaders.Add("Accept", "application/json");
...
builder.Services.AddHttpClient<Prym.Client.Services.Store.IStoreUserGroupService, Prym.Client.Services.Store.StoreUserGroupService>(client =>
{
    client.BaseAddress = new Uri(apiBaseUrl);
    client.Timeout = TimeSpan.FromSeconds(30);
    client.DefaultRequestHeaders.Add("Accept", "application/json");
...
builder.Services.AddHttpClient<Prym.Client.Services.Station.IStationService, Prym.Client.Services.Station.StationService>(client =>
{
    client.BaseAddress = new Uri(apiBaseUrl);
    client.Timeout = TimeSpan.FromSeconds(30);
    client.DefaultRequestHeaders.Add("Accept", "application/json");
