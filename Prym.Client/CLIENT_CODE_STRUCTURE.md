# Prym Client Code Structure

## Overview
This document describes the organization and architecture of the Prym Blazor WebAssembly client application.
...
❌ **REMOVED** - All SuperAdmin pages moved to Server Dashboard (Prym.Server)
...
The Prym client codebase demonstrates:
