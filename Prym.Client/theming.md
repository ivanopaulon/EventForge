...
Prym uses a modern theming system based on **Carbon/Neon** design principles, providing both dark and light modes with consistent styling across MudBlazor and Syncfusion components.
...
- **ThemeService**: `Prym.Client/Services/ThemeService.cs`
- **MainLayout**: `Prym.Client/Layout/MainLayout.razor`
- **CSS Theme**: `Prym.Client/wwwroot/css/themes/carbon-neon-theme.css`
- **Index HTML**: `Prym.Client/wwwroot/index.html`
