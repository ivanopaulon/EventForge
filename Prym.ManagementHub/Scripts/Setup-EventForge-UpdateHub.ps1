...
# ==============================================================================
#  EventForge UpdateHub - IIS Full Setup Script
#  Deploy path : C:\Prym\UpdateHub
#  Port        : 7244
#  App Pool    : EventForgeHub
#  IIS Site    : EventForge UpdateHub
#  .NET Target : 10
# ==============================================================================
...
$oldHttpRule = Get-NetFirewallRule -DisplayName "EventForge UpdateHub HTTP $SITE_PORT" -ErrorAction SilentlyContinue
if ($oldHttpRule) {
    Remove-NetFirewallRule -DisplayName "EventForge UpdateHub HTTP $SITE_PORT" -ErrorAction SilentlyContinue
    Write-OK "Vecchia regola 'HTTP $SITE_PORT' rimossa"
}

$ruleName     = "EventForge UpdateHub HTTPS $SITE_PORT"
...
if (!$deployOk) {
    ...
    Write-WARN "  dotnet publish EventForge.UpdateHub -c Release -o `"$DEPLOY_PATH`""
    Write-WARN "======================================================"
}
