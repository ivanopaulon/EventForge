namespace Prym.ManagementHub.Configuration;

/// <summary>
/// Strongly-typed configuration for Prym ManagementHub.
/// Bound from the "ManagementHub" section of appsettings.json.
/// </summary>
public class ManagementHubOptions
{
    public const string SectionName = "ManagementHub";
    ...
    /// <see cref="ServerCallbackUrl"/>. Must match <c>ManagementHub:MaintenanceCallbackSecret</c> on
