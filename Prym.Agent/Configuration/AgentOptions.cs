...
{
    /// <summary>Configuration for the Prym Server component.</summary>
    public ServerComponentOptions Server { get; set; } = new();

    /// <summary>Configuration for the Prym Client component.</summary>
    public ClientComponentOptions Client { get; set; } = new();
}

/// <summary>Deployment settings for the Prym Server component.</summary>
public class ServerComponentOptions
{
    ...
    /// <summary>
    /// Base URL of the running Prym.Server (e.g. "http://localhost:5000") used to send
    ...
    /// <summary>
    /// Shared secret that must match <c>UpdateHub:MaintenanceSecret</c> on Prym.Server.
    /// Sent as the <c>X-Maintenance-Secret</c> request header.
    /// </summary>
    public string MaintenanceSecret { get; set; } = string.Empty;
}

/// <summary>Deployment settings for the Prym Client (Blazor WebAssembly) component.</summary>
