...
public class StockMovement : AuditableEntity
{
    ...
    /// <summary>
    /// True when the movement is a technical adjustment generated by stock reconciliation.
    /// These movements are used to align stock and should not be re-consumed as operational events.
    /// </summary>
    public bool IsReconciliationAdjustment { get; set; }

    /// <summary>
    /// Reconciliation run identifier that generated this movement (if applicable).
    /// </summary>
