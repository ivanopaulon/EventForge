...
{
    /// <inheritdoc />
    public partial class AddLicensingSystem : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TenantLicenses_Tenants_TargetTenantId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LicenseFeaturePermissions_LicenseFeatureId_PermissionId",
                table: "LicenseFeaturePermissions",
                columns: new[] { "LicenseFeatureId", "PermissionId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LicenseFeatures_LicenseId_Name",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TenantLicenses_TargetTenantId_IsLicenseActive",
                table: "TenantLicenses",
                columns: new[] { "TargetTenantId", "IsLicenseActive" },
                unique: true,
                filter: "[IsLicenseActive] = 1");
