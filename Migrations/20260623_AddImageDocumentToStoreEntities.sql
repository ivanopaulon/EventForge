-- ============================================================
-- Migration: 20260623_AddImageDocumentToStoreEntities
-- Aligns store image foreign keys with ON DELETE SET NULL and
-- adds image support for StoreUserPrivileges.
-- ============================================================
...
BEGIN
    ALTER TABLE [StoreUserPrivileges]
        ADD [ImageDocumentId] uniqueidentifier NULL;
END
GO
...
BEGIN
    ALTER TABLE [StoreUserPrivileges]
        ADD CONSTRAINT [FK_StoreUserPrivileges_DocumentReferences_ImageDocumentId]
        FOREIGN KEY ([ImageDocumentId]) REFERENCES [DocumentReferences] ([Id])
        ON DELETE SET NULL;
END
GO
...
BEGIN
    CREATE INDEX [IX_StoreUserPrivilege_ImageDocumentId]
        ON [StoreUserPrivileges] ([ImageDocumentId]);
END
GO
