...
{
    private string IncomingPath => configuration["UpdateHub:IncomingPackagesPath"] ?? "packages/incoming";
    private string StorePath => configuration["UpdateHub:PackageStorePath"] ?? "packages";
