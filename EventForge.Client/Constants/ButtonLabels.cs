namespace EventForge.Client.Constants;

/// <summary>
/// Centralized button labels and text constants for the EventForge application.
/// </summary>
public static class ButtonLabels
{
    // Common action buttons
    public const string Save = "Salva";
    public const string Cancel = "Annulla";
    public const string Create = "Crea";
    public const string Edit = "Modifica";
    public const string Delete = "Elimina";
    public const string Add = "Aggiungi";
    public const string Remove = "Rimuovi";
    public const string Update = "Aggiorna";
    public const string Submit = "Invia";
    public const string Reset = "Reimposta";
    public const string Clear = "Cancella";
    public const string Search = "Cerca";
    public const string Filter = "Filtra";
    public const string Export = "Esporta";
    public const string Import = "Importa";
    public const string Download = "Scarica";
    public const string Upload = "Carica";
    public const string Back = "Indietro";
    public const string Next = "Avanti";
    public const string Previous = "Precedente";
    public const string Finish = "Termina";
    public const string Close = "Chiudi";
    ...
    public const string Enable = "Abilita";
    ...
    public const string Duplicate = "Duplica";
    public const string Move = "Sposta";
    public const string Archive = "Archivia";
    public const string Restore = "Ripristina";
    ...
    public const string ToggleTheme = "Cambia Tema";
}
...
{
    // Success messages
    public const string OperationSuccessful = "Operazione completata con successo";
    public const string SaveSuccessful = "Salvato con successo";
    ...
    public const string CreateFailed = "Creazione fallita";
    ...
    public const string UnsavedChanges = "Ci sono modifiche non salvate. Vuoi continuare?";
}