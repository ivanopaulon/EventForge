...
# ==============================================================================
#  EventForge UpdateAgent - Windows Service Setup Script
#  Deploy path   : C:\Prym\UpdateAgent
#  Service name  : EventForgeUpdateAgent
#  Display name  : EventForge Update Agent
#  .NET Target   : 10
# ==============================================================================
...
$SERVICE_NAME    = "EventForgeUpdateAgent"
$SERVICE_DISPLAY = "EventForge Update Agent"
$SERVICE_DESC    = "Manages EventForge installation updates by communicating with the remote EventForge UpdateHub."
$APP_EXE         = "EventForge.UpdateAgent.exe"
...
Write-Host "  EventForge UpdateAgent Service Setup - $(Get-Date -Format 'dd/MM/yyyy HH:mm:ss')" -ForegroundColor Magenta
...
if (!$deployOk) {
    ...
    Write-WARN "  dotnet publish EventForge.UpdateAgent -c Release -r win-x64 --self-contained false -o `"$DEPLOY_PATH`""
    Write-WARN "======================================================"
}
    ...
    if ($svcToStart) {
        try {
            ...
            if ($svcToStart.Status -eq "Running") {
                ...
                Write-WARN "Controlla Event Viewer: Applicazione -> EventForge Update Agent"
            }
        } catch {
